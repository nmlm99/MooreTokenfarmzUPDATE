...
import MOOREToken from '../abis/Token.json'
...
class App extends Component {
  ...
  async loadBlockchainData() {
    ...
    // Load MOOREToken
    const MOORETokenData = DappToken.networks[networkId]
    if(MOORETokenData) {
      const MOOREToken = new web3.eth.Contract(Token.abi, MOORETokenData.address)
